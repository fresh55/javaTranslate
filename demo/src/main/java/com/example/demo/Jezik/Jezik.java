...
public class Jezik {
    @Id
    @SequenceGenerator(name = "jezik_sequence", sequenceName = "jezik_sequence", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "jezik_sequence")
    private long id;
    private String ime;
